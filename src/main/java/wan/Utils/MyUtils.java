...
public class MyUtils {
     ...
     * @throws IOException
     */
    public static Stage createAndShowStage(Object o, Stage primaryStage, String title, String fxmlName, String iconName, int width, int height) throws IOException {
